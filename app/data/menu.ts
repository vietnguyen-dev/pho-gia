export const menuData = {
  ...
  beef: {
    ...
    items: [
      ...
      },
      {
        num: 79,
        name: "Bò Xào Sả Ớt",
        desc: "Beef stir-fried with lemongrass & chili",
        price: "16.95",
      },
      {
        num: 80,
        name: "Bò Xào Bông Cải",
        desc: "Beef stir-fried with broccoli",
        price: "15.95",
      },
      {
        num: 81,
        name: "Bò Kho",
        desc: "Vietnamese beef stew with bread",
        price: "15.95",
      },
      { num: 82, name: "Bò Tái Chanh", desc: "Rare beef in lime juice", price: "14.95" },
    ],
  },
  ...
  houseSpecialties: {
    ...
    items: [
      ...
      { num: 85, name: "Tôm Rang Muối", desc: "Salt & pepper shrimp", price: "17.95" },
      {
        num: 86,
        name: "Gà Xào Sả Ớt",
      ...
      { num: 88, name: "Cà Ri Gà", desc: "Vietnamese chicken curry", price: "15.95" },
    ],
  },
  ...
  drinks: {
    ...
    items: [
      { num: 89, name: "Cà Phê Sữa Đá", desc: "Vietnamese iced coffee", price: "5.50" },
      { num: 90, name: "Cà Phê Đen Đá", desc: "Black iced coffee", price: "4.50" },
      { num: 91, name: "Trà Đá", desc: "Vietnamese iced tea", price: "2.50" },
      { num: 92, name: "Sinh Tố Bơ", desc: "Avocado smoothie", price: "6.50" },
      { num: 93, name: "Nước Mía", desc: "Fresh sugarcane juice", price: "5.50" },
      { num: 94, name: "Chanh Muối", desc: "Salted lemonade", price: "4.50" },
    ],
  },
  ...
  desserts: {
    ...
    items: [
      ...
      { num: 97, name: "Bánh Flan", desc: "Vietnamese caramel custard", price: "4.95" },
      { num: 98, name: "Kem Dừa", desc: "Coconut ice cream", price: "4.95" },
    ],
  },
};
