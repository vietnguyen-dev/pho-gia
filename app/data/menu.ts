export const menuData = {
  appetizers: {
    ...
    items: [
      { name: "Goi Cuon (2)", desc: "Fresh spring rolls with shrimp & pork", price: "6.95" },
      { name: "Cha Gio (3)", desc: "Crispy egg rolls", price: "7.95" },
      { name: "Banh Xeo", desc: "Vietnamese crispy crepe with shrimp & pork", price: "12.95" },
      ...
      { name: "Crab Rangoon (6)", desc: "Cream cheese & crab wontons", price: "7.95" },
      { name: "Tom Chien (6)", desc: "Fried shrimp", price: "8.95" },
    ],
  },
  salads: {
    title: "Salads",
    ...
    items: [
      { name: "Goi Ga", desc: "Shredded chicken cabbage salad", price: "12.95" },
      { name: "Goi Tom", desc: "Shrimp salad with herbs & pickled vegetables", price: "13.95" },
      { name: "Goi Bo", desc: "Beef salad with lemongrass & onions", price: "13.95" },
      { name: "Goi Chay", desc: "Vegetarian salad with tofu & fresh herbs", price: "11.95" },
    ],
  },
  pho: {
    title: "Pho - Beef Noodle Soups",
  ...
  eggNoodle: {
    ...
    items: [
      ...
      { name: "Mi Bo Kho", desc: "Egg noodle with beef stew", price: "15.95" },
      { name: "Mi Ga", desc: "Egg noodle soup with chicken", price: "14.95" },
      { name: "Mi Xao Mem", desc: "Soft fried egg noodles with vegetables", price: "14.95" },
      { name: "Mi Xao Don", desc: "Crispy egg noodles with seafood", price: "15.95" },
    ],
  },
  bun: {
    title: "Bun - Vermicelli Noodles",
  ...
  com: {
    ...
    items: [
      ...
      { name: "Com Chien Tom", desc: "Shrimp fried rice", price: "15.95" },
    ],
  },
  beef: {
    title: "Beef Entrees",
    ...
    items: [
      { name: "Bo Luc Lac", desc: "Shaking beef with garlic & pepper", price: "16.95" },
      { name: "Bo Xao Xa Ot", desc: "Beef stir-fried with lemongrass & chili", price: "16.95" },
      { name: "Bo Xao Bong Cai", desc: "Beef stir-fried with broccoli", price: "15.95" },
      { name: "Bo Kho", desc: "Vietnamese beef stew with bread", price: "15.95" },
      { name: "Bo Tai Chanh", desc: "Rare beef in lime juice", price: "14.95" },
    ],
  },
  houseSpecialties: {
    ...
    items: [
      { name: "Hu Tieu Nam Vang", desc: "Clear pork broth with seafood noodles", price: "15.95" },
      { name: "Ca Kho To", desc: "Caramelized fish in clay pot", price: "16.95" },
      { name: "Tom Rang Muoi", desc: "Salt & pepper shrimp", price: "17.95" },
      { name: "Ga Xao Sa Ot", desc: "Lemongrass chili chicken", price: "15.95" },
      { name: "Suon Nuong", desc: "Grilled pork ribs with lemongrass", price: "17.95" },
      { name: "Ca Ri Ga", desc: "Vietnamese chicken curry", price: "15.95" },
    ],
  },
  drinks: {
    title: "Drinks",
  ...
  desserts: {
    ...
    items: [
      { name: "Che Ba Mau", desc: "Three-color dessert with beans & coconut", price: "5.95" },
      { name: "Che Chuoi", desc: "Banana & tapioca in coconut milk", price: "5.95" },
      { name: "Banh Flan", desc: "Vietnamese caramel custard", price: "4.95" },
      { name: "Kem Dua", desc: "Coconut ice cream", price: "4.95" },
    ],
  },
};
...
export const filters = [
  ...
  { key: "pho", label: "Pho - Beef Noodle Soups" },
  { key: "eggNoodle", label: "Egg Noodle Soups" },
  { key: "bun", label: "Bun - Vermicelli Noodles" },
  { key: "com", label: "Com - Rice Entrees" },
